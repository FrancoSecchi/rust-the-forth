...
fn test_add_operations() {
    ...
    assert_eq!(eval_forth_calculator("1 2 3 +", DEFAULT_STACK_SIZE), vec![1, 5]);
}

#[test]
fn test_sub_operations() {
    assert_eq!(eval_forth_calculator("3 4 -", DEFAULT_STACK_SIZE), vec![-1]);
    assert_eq!(eval_forth_calculator("1 12 3 -", DEFAULT_STACK_SIZE), vec![1, 9]);
}

#[test]
fn test_mul_operations() {
    assert_eq!(eval_forth_calculator("2 4 *", DEFAULT_STACK_SIZE), vec![8]);
    assert_eq!(eval_forth_calculator("1 2 3 *", DEFAULT_STACK_SIZE), vec![1, 6]);
}
...
fn test_div_operations() {
    ...
    assert_eq!(eval_forth_calculator("1 12 3 /", DEFAULT_STACK_SIZE), vec![1, 4]);
}

#[test]
fn test_mixed_operations() {
    assert_eq!(eval_forth_calculator("1 2 + 4 -", DEFAULT_STACK_SIZE), vec![-1]);
    assert_eq!(eval_forth_calculator("2 4 * 3 /", DEFAULT_STACK_SIZE), vec![2]);
    assert_eq!(eval_forth_calculator("1 3 4 * +", DEFAULT_STACK_SIZE), vec![13]);
    assert_eq!(eval_forth_calculator("1 3 4 + *", DEFAULT_STACK_SIZE), vec![7]);
}