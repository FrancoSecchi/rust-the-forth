...
fn test_boolean_operations() {
    // AND
    assert_eq!(eval_forth_calculator("-1 -1 and", DEFAULT_STACK_SIZE), vec![-1]); 
    assert_eq!(eval_forth_calculator("-1 0 and", DEFAULT_STACK_SIZE), vec![0]);   
    assert_eq!(eval_forth_calculator("0 0 and", DEFAULT_STACK_SIZE), vec![0]);
    ...
    // OR
    assert_eq!(eval_forth_calculator("-1 -1 or", DEFAULT_STACK_SIZE), vec![-1]);  // True OR True = True
    assert_eq!(eval_forth_calculator("-1 0 or", DEFAULT_STACK_SIZE), vec![-1]);   // True OR False = True
